...
public class VacancyDTOInput implements Serializable {
	...
	private CompanyDTOInput companyDTOInput;

	public VacancyDTOInput() {
		super();
	}

	public VacancyDTOInput(Long id, String name, boolean immediateHiring, boolean needExperience,
			boolean disabledPeople, boolean forStudents, String workSchedule, String salary, boolean salaryToNegotiate,
			String description, String benefits, TypeJobDTO typeJobDTO, TypeOfWorkloadDTO typeOfWorkloadDTO,
			TypeOfPayDTO typeOfPayDTO, CityDTO cityDTO, CompanyDTOInput companyDTOInput) {
		super();
		this.id = id;
		this.name = name;
		...
		this.companyDTOInput = companyDTOInput;
	}
	...
	public CompanyDTOInput getCompanyDTOInput() {
		return companyDTOInput;
	}

	public void setCompanyDTOInput(CompanyDTOInput companyDTOInput) {
		this.companyDTOInput = companyDTOInput;
	}
}